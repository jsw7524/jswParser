...
//  DateTime: 2019/2/7 下午 10:16:25
//  UserName: netsp
//  GPLEX input file <MyLanguage.Language.analyzer.lex - 2019/2/7 下午 10:12:33>
...
/* skip */
            break;
        case 2: // Recognized '{LeftPar}',	Shortest string "("
return (int)Token.LeftPar;
            break;
        case 3: // Recognized '{RightPar}',	Shortest string ")"
return (int)Token.RightPar;
            break;
        case 4: // Recognized '{OpMul}',	Shortest string "*"
return (int)Token.Mul;
            break;
        case 5: // Recognized '{OpAdd}',	Shortest string "+"
return (int)Token.Add;
            break;
        case 6: // Recognized '{OpMinus}',	Shortest string "-"
return (int)Token.Minus;
            break;
        case 7: // Recognized '{Number}',	Shortest string "."
...
return (int)Token.Div;
            break;
        case 9: // Recognized '{OpPow}',	Shortest string "^"
Console.WriteLine("XXXXX"); return (int)Token.Pow;
            break;
        default:
            break;
    }
